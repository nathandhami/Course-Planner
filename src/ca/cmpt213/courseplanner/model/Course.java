...
public class Course {
	...
	public static Comparator<Course> CourseNameComparator = new Comparator<Course>() {
		...
		public int compare(Course c1, Course c2) {
		   String first = c1.getFullCourseName() + c1.getSemesterId() 
				   			+ c1.getLocation() + c1.getCourseType();
		   String second = c2.getFullCourseName() + c2.getSemesterId() 
				   			+ c2.getLocation() + c2.getCourseType();
